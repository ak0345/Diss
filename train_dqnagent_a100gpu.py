...
def train_dqn_agent(num_episodes=1000, save_interval=50, log_dir="training_logs", model_dir="models", eval_interval=100, self_play_start=2000, opponent_cycle=3):
    """
...
def evaluate_agent(agent, num_episodes=1000, verbose=True):
    """
